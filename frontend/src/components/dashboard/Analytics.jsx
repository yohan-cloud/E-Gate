        ...
        <>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(220px,1fr))", gap: 12, marginBottom: 16 }}>
            {headerStats.map((card) => (
              <div key={card.label} style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 12, display: "flex", alignItems: "center", justifyContent: "space-between", background: "#fff" }}>
                <div>
            ...
            {selectedEventId && (
              <div>
                <div style={{ display: "grid", gap: 12 }}>
                  {attendees.map((a) => (
                    <div key={a.id} style={{ border: "1px solid #e5e7eb", borderRadius: 12, padding: 16, display: "grid", gridTemplateColumns: "1fr auto", gap: 12, alignItems: "center" }}>
...
function Kpi({ label, value }) {
  return (
    <div style={{ flex: "1 1 220px", padding: "14px 16px", border: "1px solid #e5e7eb", borderRadius: 12, background: "#fff" }}>
