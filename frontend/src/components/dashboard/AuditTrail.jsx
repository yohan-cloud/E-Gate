    ...
    <div className="card" style={{ marginTop: 12 }}>
      <div className="section-head">
        ...
        <div className="stack-row audit-summary-row">
          ...
          <div className="pill-light audit-summary-pill">Editors/Actors: <b>{summary.actors}</b></div>
          <button className="audit-refresh-button" onClick={load}>Refresh</button>
        </div>
      </div>

      <div className="audit-filter-grid audit-filter-shell">
        <input
        ...
        <input
          ...
          onKeyDown={(e) => { if (e.key === "Enter") load(); }}
        />
        <select className="audit-filter-input" value={filters.action} onChange={(e) => setFilters((curr) => ({ ...curr, action: e.target.value }))}>
      ...
      <div className="stack-row audit-action-row" style={{ marginTop: 10 }}>
        <button className="btn-primary audit-apply-button" onClick={load}>Apply Filters</button>
        <button
