              ...
              {isEnded ? (
                ...
                <button
                  ...
                  style={{
                    width: "100%",
                    padding: "10px 0",
                    background: registrationLocked ? "#94a3b8" : "#0f172a",
                    borderColor: registrationLocked ? "#94a3b8" : "#0f172a",
                    borderRadius: 10,
                ...
                >
                  {registered ? "Unregister" : registrationLocked ? "Verify Account to Register" : "Register for Event"}
                </button>
              )}
            </div>
          );
