...
urlpatterns = [
    ...
    path("gate-audit-logs/", views.GateAuditLogListView.as_view(), name="gate_audit_logs"),
    path("gate-operators/<int:user_id>/audit-logs/", views.GateOperatorAuditLogListView.as_view(), name="gate_operator_audit_logs"),
